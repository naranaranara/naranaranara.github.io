---
layout: post
title:  "The Strong Form & Weak Form of 1-D linear elliptic PDEs"
toc: true          # 우측 목차
...
![캔틸레버빔]({{ site.baseurl }}/assets/img/cantileverbeam.png)  
...
만약에 경계조건이 $x=L$에서 Neuman B.C.라면 처음에 $u_{,z}$ 먼저 계산하고 $Eu_{,x}$ 경계조건을 적용한다.  
  ...
  Find 
  $$
  u(x) \in S=\{u|\underbrace{u(0)=u_o}_{\text{consider Dirichlet B.C. at x=0}}\}
  $$  
  given 
  $$
  u_o,t,f(x)
...
![w함수]({{ site.baseurl }}/assets/img/fuctionw.png)  
